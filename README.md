...
If you like to activly monitor your IAM user permissions for the IAM action, UpdateAccountPasswordPolicy, consider making use of the IAM Canary concept I publish on github. <br/> https://github.com/hassantahhan/iamcanary <br/>
